...
namespace bridge {
    ...
    class Bridge {
      public:
        ...
        auto read_workspace_information() -> std::optional<WorkspaceInfo>;
        ...
        auto read_animations_information() -> std::optional<AnimationPropertiesInfo>;
        auto read_props_information() -> std::optional<PropsInfo>;
      ...
      private:
        ...
        std::optional<roblox::Instance> m_workspace_information;
        ...
        std::optional<roblox::Instance> m_animations_information;
        std::optional<roblox::Instance> m_props_information;
    };
