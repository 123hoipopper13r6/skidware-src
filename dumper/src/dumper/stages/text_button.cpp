...
namespace dumper::stages::text_button {
    ...
    auto dump() -> bool {
        ...
        dumper::g_dumper.add_offset("TextButton", "LineHeight", *line_height_offset, "", FieldType::Float);
        ...
        dumper::g_dumper.add_offset("TextButton", "RichText", *rich_text_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("TextButton", "TextColor3", *text_color_offset, "", FieldType::Color3Float);
        ...
        dumper::g_dumper.add_offset("TextButton", "TextDirection", *text_direction_offset, "", FieldType::UInt8);
        ...
        dumper::g_dumper.add_offset("TextButton", "TextScaled", *text_scaled_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("TextButton", "TextSize", *text_size_offset, "", FieldType::Float);
        ...
        dumper::g_dumper.add_offset("TextButton", "TextStrokeColor3", *text_stroke_color_offset, "", FieldType::Color3Float);
        ...
        dumper::g_dumper.add_offset("TextButton", "TextTransparency", *text_transparency_offset, "", FieldType::Float);
        ...
        dumper::g_dumper.add_offset("TextButton", "TextTruncate", *text_truncate_offset, "", FieldType::UInt8);
        ...
        dumper::g_dumper.add_offset("TextButton", "TextWrapped", *text_wrapped_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("TextButton", "TextXAlignment", *text_x_alignment_offset, "", FieldType::UInt8);
        ...
        dumper::g_dumper.add_offset("TextButton", "TextYAlignment", *text_y_alignment_offset, "", FieldType::UInt8);
        ...
        dumper::g_dumper.add_offset("TextButton", "AutoButtonColor", *auto_button_color_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("TextButton", "Selected", *selected_offset, "", FieldType::Bool);
