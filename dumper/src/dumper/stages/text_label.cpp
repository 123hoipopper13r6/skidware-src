...
namespace dumper::stages::text_label {
    ...
    auto dump() -> bool {
        ...
        dumper::g_dumper.add_offset("TextLabel", "LineHeight", *line_height_offset, "", FieldType::Float);
        ...
        dumper::g_dumper.add_offset("TextLabel", "RichText", *rich_text_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("TextLabel", "TextColor3", *text_color_offset, "", FieldType::Color3Float);
        ...
        dumper::g_dumper.add_offset("TextLabel", "TextDirection", *text_direction_offset, "", FieldType::UInt8);
        ...
        dumper::g_dumper.add_offset("TextLabel", "TextScaled", *text_scaled_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("TextLabel", "TextSize", *text_size_offset, "", FieldType::Float);
        ...
        dumper::g_dumper.add_offset("TextLabel", "TextStrokeColor3", *text_stroke_color_offset, "", FieldType::Color3Float);
        ...
        dumper::g_dumper.add_offset("TextLabel", "TextTransparency", *text_transparency_offset, "", FieldType::Float);
        ...
        dumper::g_dumper.add_offset("TextLabel", "TextTruncate", *text_truncate_offset, "", FieldType::UInt8);
        ...
        dumper::g_dumper.add_offset("TextLabel", "TextWrapped", *text_wrapped_offset, "", FieldType::Bool);
        ...
        dumper::g_dumper.add_offset("TextLabel", "TextXAlignment", *text_x_alignment_offset, "", FieldType::UInt8);
        ...
        dumper::g_dumper.add_offset("TextLabel", "TextYAlignment", *text_y_alignment_offset, "", FieldType::UInt8);
