...
namespace dumper::stages::player {
    auto dump() -> bool {
        ...
        if (player_info->camera_max_zoom > 0.f && player_info->camera_min_zoom > 0.f) {
            FIND_AND_ADD_OFFSET_C(*local_player_addr, Player, float, CameraMaxZoomDistance,
                                  player_info->camera_max_zoom, 0x800, 0x4, FieldType::Float,
                                  "DataModel>Players>LocalPlayer");
            FIND_AND_ADD_OFFSET_C(*local_player_addr, Player, float, CameraMinZoomDistance,
                                  player_info->camera_min_zoom, 0x800, 0x4, FieldType::Float,
                                  "DataModel>Players>LocalPlayer");
        }
